...
st.write("###### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;✔️ Objetivo Atingido: <span style='font-weight:normal;'>Sim, foi apresentada a funcionalidade de transcrição em tempo real e como esta pode ser utilizada para gerar sumários automáticos.</span>", unsafe_allow_html=True)
...
st.write("###### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;✔️ Objetivo Atingido: <span style='font-weight:normal;'>Sim, foi feita uma demonstração real do sistema, onde geraram-se sumários automáticos e atribuíram-se tarefas aos participantes com base no conteúdo da reunião.</span>", unsafe_allow_html=True)
